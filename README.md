...
```
So what this script does: It reads python module at compile time and when initialized it writes it back to disk making a usable module. After initialization it makes parsing and  calls to Python.
